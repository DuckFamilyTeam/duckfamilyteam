  ...
  return (
    <>
      ...
      <main className="pt-24">
        ...
        <section className="bg-ink-bg text-ink-text px-6 md:px-12 pt-8 pb-20 md:pb-28">
          <div className="max-w-7xl mx-auto">
            ...
            <div className="flex flex-col sm:flex-row gap-4 mb-20 md:mb-24">
              <Link
                href="#kontakt"
                className="bg-wine hover:bg-wine-bright text-ink-text px-8 py-4 rounded-xl font-medium text-center transition-colors"
              >
        ...
        {/* ── BLOG PREVIEW ── */}
        <section id="blog" className="py-20 px-6 md:px-12 bg-ink-surface">
          <div className="max-w-7xl mx-auto">
            <AnimatedSection className="flex flex-col md:flex-row justify-between items-end mb-12 gap-6">
              <div className="max-w-2xl">
                <h2 className="font-display font-medium text-3xl md:text-5xl text-ink-text tracking-tight mb-4">
              ...
              <Link
                href="/blog"
                className="border border-ink-border hover:border-wine text-ink-text px-8 py-4 rounded-xl font-medium transition-colors whitespace-nowrap"
              >
                Vidi sve tekstove
              </Link>
            </AnimatedSection>
            ...
            <div className="grid md:grid-cols-3 gap-6">
              {[
                ...
                <AnimatedSection key={post.title} delay={i * 100}>
                  <Link
                    href={post.href}
                    className="group bg-ink-bg border border-ink-border hover:border-wine rounded-2xl overflow-hidden flex flex-col h-full transition-colors"
                  >
                    ...
                    <div className="p-6 flex-1 flex flex-col">
                      <h3 className="font-display font-medium text-lg text-ink-text mb-3 leading-snug">{post.title}</h3>
                      <p className="text-ink-muted text-sm mb-5 flex-1">{post.excerpt}</p>
