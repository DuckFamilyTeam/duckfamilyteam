        ...
        <section className="py-20 px-6 md:px-12 bg-slate-900 text-white">
          <div className="max-w-7xl mx-auto">
            ...
            <div className="grid md:grid-cols-2 gap-8">
              <AnimatedSection className="bg-white/5 backdrop-blur-sm rounded-[2.5rem] md:rounded-[3rem] p-8 md:p-10 border border-white/10">
                <div className="flex items-start gap-4 mb-6">
                  <Image
                    src="/img/cekic-logo.svg"
                    alt="Auto Čekić - E-commerce sajt"
                    width={60}
                    height={60}
                    className="rounded-xl bg-white p-2"
                  />
                  <div>
                    <h3 className="text-2xl font-black mb-1">Auto Čekić</h3>
                    <p className="text-slate-400 text-sm font-bold uppercase tracking-widest">E-commerce | Auto Delovi</p>
                  </div>
                </div>
                <p className="text-slate-300 leading-relaxed mb-8">
                  Povećanje konverzija za <strong className="text-teal-400">340%</strong> kroz optimizovane Google Shopping kampanje i precizno targetiranje. ROAS skočio sa 2:1 na <strong className="text-teal-400">6.2:1</strong>.
                </p>
                <a
                  href="https://autocekic.rs"
                  target="_blank"
              ...
              <AnimatedSection delay={100} className="bg-white/5 backdrop-blur-sm rounded-[2.5rem] md:rounded-[3rem] p-8 md:p-10 border border-white/10">
                <div className="flex items-start gap-4 mb-6">
                  <div className="w-[60px] h-[60px] rounded-xl bg-[#248a84] flex items-center justify-center text-white font-black text-2xl">
                    G
                  </div>
                  <div>
                    <h3 className="text-2xl font-black mb-1">Gradnja Nišava</h3>
                    <p className="text-slate-400 text-sm font-bold uppercase tracking-widest">Građevinska Kompanija</p>
                  </div>
                </div>
                <p className="text-slate-300 leading-relaxed mb-8">
                  SEO strategija koja je u 8 meseci dovela do <strong className="text-blue-400">TOP 3 pozicije</strong> za 12 glavnih ključnih reči. Organski saobraćaj porastao za <strong className="text-blue-400">520%</strong>.
                </p>
                <a
                  href="https://gradjanisava.rs"
                  target="_blank"
                  rel="noopener noreferrer"
                  className="inline-flex items-center gap-3 text-[#248a84] font-black text-sm uppercase tracking-widest hover:gap-5 transition-all"
                >
                  Vidi projekat uživo
                  <svg className="w-4 h-4" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M17 8l4 4m0 0l-4 4m4-4H3" />
