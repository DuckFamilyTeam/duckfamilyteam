...
export const metadata: Metadata = {
  ...
  openGraph: {
    title: 'SEO u 2026: šta zaista radi za Google rangiranje',
      ...
      <main className="bg-ink-bg text-ink-text pt-28 md:pt-40 pb-20 px-4 md:px-6">
        <article className="max-w-4xl mx-auto">
          ...
          <nav className="mb-8 font-mono text-xs uppercase tracking-widest text-ink-muted flex items-center gap-2" aria-label="Breadcrumb">
            ...
            <span>/</span>
            <span className="text-ink-text">SEO u 2026</span>
          </nav>
          ...
          <div className="bg-ink-surface border border-ink-border rounded-2xl p-6 md:p-12 lg:p-16 space-y-10 md:space-y-12 text-ink-muted text-base md:text-xl">
            ...
            <div className="space-y-4 md:space-y-6">
              ...
              <p className="leading-relaxed">
                ...
                Sada: <strong className="text-ink-text">relevantnost teme, kvalitet odgovora, E-E-A-T, tehnička baza</strong>, sve to zajedno jednako rangiranje.
              </p>
            ...
            <div className="space-y-4 md:space-y-6">
              ...
              <p className="leading-relaxed">
                Umesto da targetujete jednu ključnu reč, u 2026. gradite <strong className="text-ink-text font-medium">tematski autoritet</strong>. To znači da Google vidi vaš sajt kao pouzdan izvor informacija za celu temu, ne samo za jedan keyword.
              </p>
              <p className="leading-relaxed">
            ...
            <div className="space-y-4 md:space-y-6">
              ...
              <p className="leading-relaxed">
                ...
                <strong>Authoritativeness</strong> (autoritet): pominjanje na drugim autoritativnim sajtovima, backlinkovi sa relevantnih izvora, citiranja.<br /><br />
              ...
              <p className="leading-relaxed">
                Za firme u Srbiji, praktična preporuka: dodajte <strong>biografiju autora</strong> na svaki blog post, navedite adresu i broj telefona u footeru, prikupljajte recenzije na Google Business Profilu.
              </p>
            </div>
            ...
            <div className="space-y-4 md:space-y-6">
              ...
              <div className="bg-ink-bg p-5 md:p-8 border-l-4 border-ink-border rounded-r-xl shadow-sm">
                <p className="text-ink-text m-0">
                  <strong className="text-ink-muted uppercase text-xs md:text-sm tracking-widest block mb-2">Bonus</strong>
            ...
            <div className="space-y-4 md:space-y-6">
              ...
              <ul className="space-y-3 pl-6 list-none">
                {[
                  'Google Business Profil kompletno popunjen (opis, kategorije, radno vreme, slike)',
                  'Minimalno 20 ili više recenzija sa prosekom 4.5 ili više',
                  'Konzistentno NAP (Name, Address, Phone) na svim platformama',
                  'Lokalne ključne reči u naslovu i opisu GBP profila',
                  'Lokalne ključne reči na sajtu (grad plus usluga)',
            ...
            <div className="bg-ink-bg border border-ink-border rounded-2xl p-6 md:p-8">
              ...
              <ul className="space-y-3 text-ink-muted">
                {[
                  ...
                  'Lokalni SEO: Google Business Profil i recenzije',
