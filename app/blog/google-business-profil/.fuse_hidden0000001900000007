      ...
      <main className="bg-ink-bg text-ink-text pt-28 md:pt-40 pb-20 px-4 md:px-6">
        <article className="max-w-4xl mx-auto">
          ...
          <div className="bg-ink-surface border border-ink-border rounded-2xl p-6 md:p-12 lg:p-16 space-y-10 md:space-y-12 text-ink-muted text-base md:text-xl">
            ...
            <p className="leading-relaxed">
              Google Business Profil, skraćeno <strong className="text-ink-text font-medium">GBP</strong> (nekadašnji Google My Business), nije "još jedna stavka na spisku obaveza". Za veliku većinu lokalnih firmi to je{' '}
              <strong className="text-ink-text font-medium">prva stranica koju klijent vidi</strong>, pre sajta, pre društvenih mreža, pre bilo čega drugog. Zato je optimizacija GBP-a jedan od najisplativijih poteza u lokalnom SEO-u, i upravo zato zaslužuje mnogo više pažnje nego što obično dobija.
            </p>
