...
export const metadata: Metadata = {
  title: 'Zašto Google oglasi troše novac bez prodaje? 7 razloga | Duck Family Team',
  description:
        ...
        <article className="max-w-4xl mx-auto">
          ...
          <div className="text-center mb-12 md:mb-16">
            ...
            <h1 className="text-2xl md:text-4xl lg:text-5xl font-extrabold text-slate-900 mt-6 mb-6 md:mb-8 leading-relaxed px-2">
              ...
              <span className="duck-gradient-text italic">troše novac</span> bez konverzija? 7 razloga
            </h1>
          ...
          <div className="bg-white border border-black/5 rounded-[1.5rem] md:rounded-[2.5rem] p-6 md:p-12 lg:p-16 space-y-10 md:space-y-12 text-slate-700 text-base md:text-xl">
            ...
            <div className="space-y-4 md:space-y-6">
              ...
              <p className="leading-relaxed">
                Zamislite da kliknete na oglas "dubinsko pranje tepiha Beograd", a sajt vas odvede na početnu stranicu gde se priča o istoriji firme i čišćenju prozora. <span className="text-red-600 font-bold">Kupac odlazi u roku od 3 sekunde.</span>
              </p>
              <p className="leading-relaxed">
                Oglas je obećanje, a vaša stranica mora biti <strong className="text-slate-900 font-bold">ispunjenje tog obećanja</strong>. Mora postojati savršena koherentnost između naslova oglasa, ključnih reči i sadržaja stranice. Google to naziva "message match" — i direktno utiče na vaš Quality Score.
              </p>
              <p className="leading-relaxed">
              ...
              <div className="bg-slate-50 p-5 md:p-8 border-l-4 border-blue-500 italic rounded-r-xl md:rounded-r-2xl shadow-sm">
                <p className="text-slate-800 m-0">
                  <strong className="text-blue-700 uppercase text-xs md:text-sm tracking-widest not-italic block mb-2">Rešenje:</strong>
            ...
            <div className="space-y-4 md:space-y-6">
              ...
              <p className="leading-relaxed">
                Ako niste ispravno podesili <strong className="text-slate-900 font-bold">Conversion Tracking</strong> u GA4, Google-ov AI luta u mraku. On optimizuje kampanju za klikove, a ne za prodaje. Rezultat? Mnogo saobraćaja, ali nula profita.
              </p>
              <p className="leading-relaxed">
              ...
              <div className="bg-slate-50 p-5 md:p-8 border-l-4 border-teal-500 italic rounded-r-xl md:rounded-r-2xl shadow-sm">
                <p className="text-slate-800 m-0">
                  <strong className="text-teal-700 uppercase text-xs md:text-sm tracking-widest not-italic block mb-2">Rešenje:</strong>
                  Podesite GA4 konverzije putem Google Tag Manager-a. Pratite svaki klik na telefon (tel: link), svaki popunjen formular, svaku kupovinu. Importujte GA4 konverzije u Google Ads. Sačekajte minimum 30-50 konverzija pre nego što aktivirate Target CPA bidding.
                </p>
              </div>
            </div>
            ...
            <div className="space-y-4 md:space-y-6">
              ...
              <p className="leading-relaxed">
                Negativne ključne reči su možda <strong>najjači alat za smanjenje troškova</strong> u Google Ads-u — i najiznošeniji. Bez robusne liste negativnih reči, vaši oglasi se prikazuju za irelevantne pretrage i vi plaćate za klikove koji nikada neće konvertovati.
              </p>
              <p className="leading-relaxed">
            ...
            <div className="space-y-4 md:space-y-6">
              ...
              <div className="bg-slate-50 p-5 md:p-8 border-l-4 border-blue-500 italic rounded-r-xl md:rounded-r-2xl shadow-sm">
                <p className="text-slate-800 m-0">
                  <strong className="text-blue-700 uppercase text-xs md:text-sm tracking-widest not-italic block mb-2">Rešenje:</strong>
                  Grupisajte ključne reči u uske ad grupe (1-3 bliske reči po grupi). Pišite naslove oglasa koji sadrže tačnu ključnu reč. Osigurajte da landing stranica ima sadržaj direktno vezan za ključnu reč. Ciljajte Quality Score 7+ za svaku reč.
                </p>
              </div>
            </div>
            ...
            <div className="space-y-4 md:space-y-6">
              ...
              <p className="leading-relaxed">
                U Srbiji, <strong>više od 60% pretrage</strong> se odvija na mobilnim uređajima. Ali za mnoge industrije, konverzije i dalje dolaze pretežno sa desktop-a jer korisnici istražuju na telefonu, a kupuju/kontaktiraju sa računara. Ako tretirate sve uređaje jednako, plaćate previše za mobilne klikove koji retko konvertuju.
              </p>
              <p className="leading-relaxed">
            ...
            <div className="bg-slate-900 rounded-2xl p-6 md:p-8">
              <h3 className="text-xl md:text-2xl font-black text-white mb-4">Brzi checklist za audit vašeg Google Ads naloga</h3>
              <ul className="space-y-3 text-slate-300">
                {[
                  ...
                  'Quality Score svih ključnih reči je 7+?',
          ...
          <div className="mt-12 p-6 bg-slate-50 rounded-2xl">
            ...
            <ul className="space-y-2">
              <li><Link href="/google-ads" className="text-teal-600 hover:underline font-medium">Google Ads Agencija Srbija — naše usluge →</Link></li>
              <li><Link href="/blog/seo-2026" className="text-teal-600 hover:underline font-medium">SEO u 2026: Da li su ključne reči i dalje bitne? →</Link></li>
              <li><Link href="/blog/ga4-vodic" className="text-teal-600 hover:underline font-medium">GA4 Vodič: Kako podesiti Google Analytics 4 →</Link></li>
            </ul>
          </div>
