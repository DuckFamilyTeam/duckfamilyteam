      ...
      <main id="glavni-sadrzaj" className="bg-ink-bg text-ink-text pt-28 md:pt-40 pb-20 px-4 md:px-6">
        <article className="max-w-4xl mx-auto">
          ...
          <nav className="mb-8 font-mono text-xs uppercase tracking-widest text-ink-muted flex items-center gap-2" aria-label="Breadcrumb">
            ...
            <span>/</span>
            <span className="text-ink-text">GA4 Vodič</span>
          </nav>
          ...
          <div className="bg-ink-surface border border-ink-border rounded-2xl p-6 md:p-12 lg:p-16 space-y-10 md:space-y-12 text-ink-muted text-base md:text-xl">
            <p className="leading-relaxed">
              ...
              <strong className="text-ink-text font-medium">Haos.</strong> Grafovi, tabele, procentualni pomaci koji ne znače apsolutno ništa vašem budžetu. Većina preduzetnika u Srbiji se tu izgubi i odustane, ili što je gore, donosi pogrešne odluke na osnovu pogrešnih metrika.
            </p>
            <p className="leading-relaxed">
            ...
            <div className="space-y-4 md:space-y-6">
              ...
              <div className="bg-ink-bg p-5 md:p-8 border-l-4 border-ink-border rounded-r-xl shadow-sm">
                <p className="text-ink-text m-0">
                  ...
                  Zavisi od industrije, ali generalno: 2 do 5% je solidno za e-commerce, 5 do 10% za B2B usluge.
                </p>
              </div>
            </div>
            ...
            <div className="space-y-4 md:space-y-6">
              ...
              <p className="leading-relaxed">
                Ovo vam daje jasnu sliku ponašanja korisnika. Vidite tačno gde oni gube interesovanje i odlaze sa sajta.
              </p>
              <div className="bg-ink-bg p-5 md:p-8 border-l-4 border-wine rounded-r-xl shadow-sm">
                <p className="text-ink-text m-0">
                  <strong className="text-wine-text uppercase text-xs md:text-sm tracking-widest block mb-2">
            ...
            <div className="space-y-4 md:space-y-6">
              ...
              <p className="leading-relaxed">
                ...
                <strong className="text-ink-text font-medium">Enhanced E-commerce</strong> ili{' '}
                <strong className="text-ink-text font-medium">konverzije sa vrednošću</strong>.
              </p>
              <div className="bg-ink-bg p-5 md:p-8 border-l-4 border-ink-border rounded-r-xl shadow-sm">
                <p className="text-ink-text m-0">
                  <strong className="text-ink-muted uppercase text-xs md:text-sm tracking-widest block mb-2">
            ...
            <div className="space-y-4 md:space-y-6">
              ...
              <p className="leading-relaxed">
                <strong className="text-ink-text font-medium">Pravilo:</strong> ako metrika ne može da se pretvori u dinare ili evro, nije bitna.
              </p>
            </div>
